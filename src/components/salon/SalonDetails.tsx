...
export const SalonDetails: React.FC<SalonDetailsProps> = ({ salon, stylists = [] }) => {
  console.log('SalonDetails received stylists:', stylists);
            ...
            <div className="grid gap-3">
              {stylists.filter(s => s.isOnDuty !== false).map((stylist) => (
                ...
                >
                  ...
                  <button className="text-xs font-medium text-purple-600 hover:bg-purple-100 px-3 py-1.5 rounded-lg transition-colors">
                    View
                  </button>
                </div>
              ))}
