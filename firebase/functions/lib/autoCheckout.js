...
exports.autoCheckoutWorker = void 0;
const functions = __importStar(require("firebase-functions"));
const admin = __importStar(require("firebase-admin"));
const db = admin.firestore();
const AUTO_CHECKOUT_HOURS = 4;
exports.autoCheckoutWorker = functions.pubsub
    .schedule('every 30 minutes')
    .onRun(async (context) => {
    const cutoffTime = admin.firestore.Timestamp.fromMillis(Date.now() - AUTO_CHECKOUT_HOURS * 60 * 60 * 1000);
    try {
