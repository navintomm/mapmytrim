...
export const onAppointmentCreate = functions.firestore
    ...
    .onCreate(async (snap, context) => {
        ...
        console.log(`New appointment created: ${appointmentId}, status: ${appointmentData?.status}`);
...
async function sendAppointmentConfirmation(appointmentId: string, appointmentData: any) {
    try {
